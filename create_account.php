...
<body>
    ...
    <div class="js-animsition animsition" id="site-wrap" data-animsition-in-class="fade-in"
        ...
        <div class="templateux-section">
            <div class="container">
                <h1 class="heading text-center">Register with Us</h1>
                <div class="row mb-5">
                    <div class="col-md-5 pr-md-5 mb-5">
                        ...
                        <div id="Student" class="tabcontent">
                            <form action="Student/student_register.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gender" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dept" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
                                    <label for="mnum">Matriculation Number</label>
                                    <input type="text" name="mat_num" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="cpassword" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div id="Counselor" class="tabcontent">
                            <form action="Counselor/counselor_register.php" method="post">
                                <div class="form-group">
                                    <label for="fname">First Name</label>
                                ...
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" name="pwd" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
                                    <label for="cpwd">Confirm Password</label>
                                    <input type="password" name="cpwd" class="form-control" id="name" required>
                                </div>
                                <div class="form-group">
